...
abstract final class ApiManager {
  ...
  static Future<List<SourceDm>> loadSources()async{
    try{
      var serverResponse = await _dio.get("https://newsapi.org/v2/top-headlines/sources?apiKey=53e681415b874bf18f3ea578a181a0a0");
  ...
  static Future<List<ArticleDm>> loadArticles(String sourceId)async{
    try{
      var serverResponse = await _dio.get("https://newsapi.org/v2/everything?q=$sourceId&apiKey=53e681415b874bf18f3ea578a181a0a0");
      if(serverResponse.statusCode! >=200 && serverResponse.statusCode!<300){
        Map<String,dynamic> json = serverResponse.data!;
